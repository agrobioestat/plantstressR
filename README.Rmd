...
columns and ask which genotypes hold their position:
...
`ecovalence_pct` names the genotypes responsible for the instability of the
trial: a genotype carrying most of the interaction is one whose ranking does
not travel.
